...
public class Register extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPasswordField1.setToolTipText("Maximun length 10 characters");
        ...
        jTextField1.setToolTipText("Maximun length 8 characters");
        ...
        jTextField2.setToolTipText("Maximun length 20 characters");
        ...
        jTextField3.setToolTipText("Maximun length 40 characters");
...
dispose();  
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (validateData()) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(this,"Registration fulfilled", "Signed up",JOptionPane.INFORMATION_MESSAGE);
                dispose();
            } catch (MyException ex) {
                JOptionPane.showMessageDialog(this, ex.getLocalizedMessage() ,"No Registered",JOptionPane.ERROR_MESSAGE);
            }
    ...
    private boolean validateData (){
        if (newUser.getUsername().isEmpty()
            ...
            JOptionPane.showMessageDialog(this, "You can not leave empty fields", "ERROR: Empty Fields", JOptionPane.ERROR_MESSAGE);
        return false;
        }
        if (newUser.getUsername().length()>8) {
            JOptionPane.showMessageDialog(this, "Maximun length 10 characters on Username field", "ERROR: Invalid length", JOptionPane.ERROR_MESSAGE);
        return false;
        }    
        if (newUser.getPassword().length()>10) {
            JOptionPane.showMessageDialog(this, "Maximun length 10 characters on Password field", "ERROR: Invalid length", JOptionPane.ERROR_MESSAGE);
        return false;
        }
        if (newUser.getName().length() >20) {
            JOptionPane.showMessageDialog(this, "Maximun length 20 characters on Name field", "ERROR: Invalid length", JOptionPane.ERROR_MESSAGE);
        return false;  
        }
        if (newUser.getSurname().length()>40) {
            JOptionPane.showMessageDialog(this, "Maximun length 40 character on Surnames", "ERROR: Invalid length", JOptionPane.ERROR_MESSAGE);
        return false;
        }
        String verification = new String (jPasswordField2.getPassword());
        if (!verification.equals(newUser.getPassword())) {
       JOptionPane.showMessageDialog(this, "Your password and confirmation password do not match", "ERROR: Password missmatch", JOptionPane.ERROR_MESSAGE); 
       return false;
        }
        return true;
    }
